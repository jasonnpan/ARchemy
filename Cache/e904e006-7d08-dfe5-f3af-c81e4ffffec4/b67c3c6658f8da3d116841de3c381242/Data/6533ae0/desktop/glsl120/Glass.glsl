...
#endif
vec3 l9_48=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_29.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_54;
