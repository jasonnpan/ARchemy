...
#if (sc_FramebufferFetch)
{
l9_184=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_184=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_185,sc_ScreenTextureLayout,l9_186).xy,0.0);
}
#endif
vec3 l9_187=mix(l9_184.xyz,definedBlend(l9_184.xyz,l9_167.xyz).xyz,vec3(l9_168));
...
#if (sc_Voxelization)
{
l9_189=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_190;
#if (sc_OutputBounds)
{
float l9_191=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_190=vec4(l9_191,1.0-l9_191,1.0,1.0);
}
#else
{
vec4 l9_192;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_192=vec4(mix(vec3(1.0),l9_167.xyz,vec3(l9_168)),l9_168);
}
#else
{
vec4 l9_193;
...
#endif
l9_193=vec4(l9_167.xyz*l9_194,l9_194);
}
#else
{
l9_193=l9_167;
