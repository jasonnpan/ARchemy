...
#endif
l9_86=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_87,sc_ScreenTextureLayout,l9_88).xy,0.0);
}
#endif
vec3 l9_89=mix(l9_86.xyz,definedBlend(l9_86.xyz,l9_70.xyz).xyz,vec3(l9_69));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_94=vec4(mix(vec3(1.0),l9_70.xyz,vec3(l9_69)),l9_69);
}
#else
{
vec4 l9_95;
...
#endif
l9_95=vec4(l9_70.xyz*l9_96,l9_96);
}
#else
{
l9_95=l9_70;
