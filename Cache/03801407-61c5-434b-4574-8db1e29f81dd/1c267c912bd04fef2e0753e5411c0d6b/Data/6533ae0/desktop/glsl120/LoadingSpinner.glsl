...
#endif
l9_17=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,l9_19).xy,0.0);
}
#endif
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_33).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_34=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_33).xy);
...
if (l9_51==0)
{
l9_54=texture2D(sc_OITAlpha0,l9_46);
l9_53=texture2D(sc_OITDepthLow0,l9_46);
l9_52=texture2D(sc_OITDepthHigh0,l9_46);
}
else
{
l9_54=vec4(0.0);
...
if (l9_51==1)
{
l9_57=texture2D(sc_OITAlpha1,l9_46);
l9_56=texture2D(sc_OITDepthLow1,l9_46);
l9_55=texture2D(sc_OITDepthHigh1,l9_46);
}
else
{
l9_57=l9_54;
...
vec4 l9_72=texture2D(sc_OITFilteredDepthBoundsTexture,l9_46);
vec2 l9_73=l9_72.xy;
int l9_74;
#if (sc_SkinBonesCount>0)
{
