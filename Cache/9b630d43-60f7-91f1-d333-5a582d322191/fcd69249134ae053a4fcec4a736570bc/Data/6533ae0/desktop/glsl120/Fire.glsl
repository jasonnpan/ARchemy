...
#endif
l9_83=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_84,sc_ScreenTextureLayout,l9_85).xy,0.0);
}
#endif
vec3 l9_86=mix(l9_83.xyz,definedBlend(l9_83.xyz,l9_67.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_91=vec4(mix(vec3(1.0),l9_67.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_92;
...
{
l9_93=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
...
#endif
l9_92=vec4(l9_67.xyz*l9_93,l9_93);
}
#else
{
l9_92=l9_67;
