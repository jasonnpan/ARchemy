...
#endif
l9_345=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_346,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#else
{
vec4 l9_347;
...
#else
{
l9_347=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_344,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#endif
l9_345=l9_347;
}
...
l9_381=mix(texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(calcSeamlessPanoramicUvsForSampling(l9_380,sc_EnvmapSpecularSize.xy,l9_382),sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_382),texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(calcSeamlessPanoramicUvsForSampling(l9_380,sc_EnvmapSpecularSize.xy,l9_383),sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_383),vec4(l9_379-l9_382));
}
#else
{
l9_381=texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_380,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_379);
}
#endif
...
#if (sc_Voxelization)
{
l9_436=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_437;
#if (sc_OutputBounds)
{
float l9_438=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_437=vec4(l9_438,1.0-l9_438,1.0,1.0);
}
#else
{
vec4 l9_439;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_440=l9_417.w;
l9_439=vec4(mix(vec3(1.0),l9_417.xyz,vec3(l9_440)),l9_440);
}
#else
{
vec4 l9_441;
...
#endif
l9_441=vec4(l9_417.xyz*l9_443,l9_443);
}
#else
{
l9_441=l9_417;
...
vec4 l9_446=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_444,vec4(0.0)));
vec4 l9_447=clamp(l9_446,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_448=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_448-0.0039215689)),min(1.0,l9_448+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_449=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_449).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_450=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_449).xy);
float l9_451=packValue(l9_450);
int l9_458=int(l9_447.w*255.0);
float l9_459=packValue(l9_458);
sc_writeFragData0Internal(vec4(packValue(l9_450),packValue(l9_450),packValue(l9_450),packValue(l9_450)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_451,packValue(l9_450),packValue(l9_450),packValue(l9_450)));
sc_writeFragData2(vec4(l9_459,packValue(l9_458),packValue(l9_458),packValue(l9_458)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_462=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_462).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_467==0)
{
l9_470=texture2D(sc_OITAlpha0,l9_462);
l9_469=texture2D(sc_OITDepthLow0,l9_462);
l9_468=texture2D(sc_OITDepthHigh0,l9_462);
}
else
{
l9_470=vec4(0.0);
...
if (l9_467==1)
{
l9_473=texture2D(sc_OITAlpha1,l9_462);
l9_472=texture2D(sc_OITDepthLow1,l9_462);
l9_471=texture2D(sc_OITDepthHigh1,l9_462);
}
else
{
l9_473=l9_470;
...
if (any(notEqual(l9_471,vec4(0.0)))||any(notEqual(l9_472,vec4(0.0))))
{
int l9_474[8]=l9_463;
unpackValues(l9_471.w,l9_467,l9_474);
unpackValues(l9_471.z,l9_467,l9_474);
unpackValues(l9_471.y,l9_467,l9_474);
unpackValues(l9_471.x,l9_467,l9_474);
unpackValues(l9_472.w,l9_467,l9_474);
unpackValues(l9_472.z,l9_467,l9_474);
unpackValues(l9_472.y,l9_467,l9_474);
unpackValues(l9_472.x,l9_467,l9_474);
int l9_483[8]=l9_464;
unpackValues(l9_473.w,l9_467,l9_483);
unpackValues(l9_473.z,l9_467,l9_483);
unpackValues(l9_473.y,l9_467,l9_483);
unpackValues(l9_473.x,l9_467,l9_483);
}
l9_467++;
continue;
}
...
vec4 l9_488=texture2D(sc_OITFilteredDepthBoundsTexture,l9_462);
vec2 l9_489=l9_488.xy;
int l9_490;
#if (sc_SkinBonesCount>0)
{
l9_490=encodeDepth(((1.0-l9_488.x)*1000.0)+getDepthOrderingEpsilon(),l9_489);
}
#else
{
l9_490=0;
...
#endif
int l9_491=encodeDepth(viewSpaceDepth(),l9_489);
vec4 l9_492;
l9_492=l9_447*l9_447.w;
vec4 l9_493;
int l9_494=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_494<8)
{
int l9_495=l9_463[l9_494];
int l9_496=l9_491-l9_490;
bool l9_497=l9_495<l9_496;
bool l9_498;
if (l9_497)
{
l9_498=l9_463[l9_494]>0;
}
else
{
l9_498=l9_497;
...
if (l9_498)
{
vec3 l9_499=l9_492.xyz*(1.0-(float(l9_464[l9_494])/255.0));
l9_493=vec4(l9_499.x,l9_499.y,l9_499.z,l9_492.w);
}
else
{
l9_493=l9_492;
...
sc_writeFragData0Internal(l9_492,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_447,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
