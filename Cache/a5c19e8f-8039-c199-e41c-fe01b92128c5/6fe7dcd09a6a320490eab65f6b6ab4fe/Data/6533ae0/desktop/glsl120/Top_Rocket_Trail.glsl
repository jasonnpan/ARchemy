...
//spec_const bool texture_mapHasSwappedViews 74 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_texture_map 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_texture_map 78 -1
...
//spec_const int texture_mapLayout 88 0
//SG_REFLECTION_END
...
#if (sc_FramebufferFetch)
{
l9_52=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_52=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_53,sc_ScreenTextureLayout,l9_54).xy,0.0);
}
#endif
vec3 l9_55=mix(l9_52.xyz,definedBlend(l9_52.xyz,l9_36.xyz).xyz,vec3(l9_35));
...
#if (sc_Voxelization)
{
l9_57=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_58;
#if (sc_OutputBounds)
{
float l9_59=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_58=vec4(l9_59,1.0-l9_59,1.0,1.0);
}
#else
{
vec4 l9_60;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_60=vec4(mix(vec3(1.0),l9_36.xyz,vec3(l9_35)),l9_35);
}
#else
{
vec4 l9_61;
...
#endif
l9_61=vec4(l9_36.xyz*l9_62,l9_62);
}
#else
{
l9_61=l9_36;
...
vec4 l9_65=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_63,vec4(0.0)));
