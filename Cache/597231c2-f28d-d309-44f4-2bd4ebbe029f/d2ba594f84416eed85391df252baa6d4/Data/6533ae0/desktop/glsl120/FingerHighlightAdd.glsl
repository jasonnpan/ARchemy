...
#endif
float l9_27=1.0-dot(normalize(varNormal),normalize(sc_Camera.position-varPos));
...
float l9_34=clamp((vec2(dot(vec2(cos(l9_33),sin(l9_33)),varPackedTex.xy-Port_Center_N018),0.0)+Port_Center_N018).x,0.0,1.0);
float l9_35;
