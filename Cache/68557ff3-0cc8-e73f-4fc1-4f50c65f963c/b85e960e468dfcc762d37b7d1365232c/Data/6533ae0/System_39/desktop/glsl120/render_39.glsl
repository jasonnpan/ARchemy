...
vec3 l9_15=sc_SamplingCoordsViewToGlobal(l9_14,renderTarget0Layout,renderTarget0GetStereoViewIndex());
vec4 l9_16=texture2DLod(renderTarget0,l9_15.xy,0.0);
bool l9_17=dot(abs(l9_16),vec4(1.0))<9.9999997e-06;
bool l9_18;
if (!l9_17)
{
l9_18=!vfxBatchEnable[ssInstanceID/40];
}
else
{
l9_18=l9_17;
...
float l9_19=1000.0-(-1000.0);
float l9_20=0.99998999-0.0;
gParticle.Position.x=(-1000.0)+(((DecodeFloat32(l9_16,true)-0.0)*l9_19)/l9_20);
gParticle.Position.y=(-1000.0)+(((DecodeFloat32(texture2DLod(renderTarget1,sc_SamplingCoordsViewToGlobal(l9_14,renderTarget1Layout,renderTarget1GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_19)/l9_20);
gParticle.Position.z=(-1000.0)+(((DecodeFloat32(texture2DLod(renderTarget2,sc_SamplingCoordsViewToGlobal(l9_14,renderTarget2Layout,renderTarget2GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_19)/l9_20);
gParticle.Velocity.x=(-1000.0)+(((DecodeFloat32(texture2DLod(renderTarget3,sc_SamplingCoordsViewToGlobal(l9_14,renderTarget3Layout,renderTarget3GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_19)/l9_20);
vec2 l9_21=l9_13+vec2(0.00048828125,0.0);
gParticle.Velocity.y=(-1000.0)+(((DecodeFloat32(texture2DLod(renderTarget0,sc_SamplingCoordsViewToGlobal(l9_21,renderTarget0Layout,renderTarget0GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_19)/l9_20);
gParticle.Velocity.z=(-1000.0)+(((DecodeFloat32(texture2DLod(renderTarget1,sc_SamplingCoordsViewToGlobal(l9_21,renderTarget1Layout,renderTarget1GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_19)/l9_20);
float l9_22=0.2-0.0;
gParticle.Life=0.0+(((DecodeFloat32(texture2DLod(renderTarget2,sc_SamplingCoordsViewToGlobal(l9_21,renderTarget2Layout,renderTarget2GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_22)/l9_20);
gParticle.Age=0.0+(((DecodeFloat32(texture2DLod(renderTarget3,sc_SamplingCoordsViewToGlobal(l9_21,renderTarget3Layout,renderTarget3GetStereoViewIndex()).xy,0.0),true)-0.0)*l9_22)/l9_20);
vec2 l9_23=l9_13+vec2(0.0009765625,0.0);
vec4 l9_24=texture2DLod(renderTarget0,sc_SamplingCoordsViewToGlobal(l9_23,renderTarget0Layout,renderTarget0GetStereoViewIndex()).xy,0.0);
vec4 l9_25=texture2DLod(renderTarget1,sc_SamplingCoordsViewToGlobal(l9_23,renderTarget1Layout,renderTarget1GetStereoViewIndex()).xy,0.0);
vec4 l9_26=texture2DLod(renderTarget2,sc_SamplingCoordsViewToGlobal(l9_23,renderTarget2Layout,renderTarget2GetStereoViewIndex()).xy,0.0);
vec4 l9_27=texture2DLod(renderTarget3,sc_SamplingCoordsViewToGlobal(l9_23,renderTarget3Layout,renderTarget3GetStereoViewIndex()).xy,0.0);
float l9_28=100.0-0.0;
gParticle.Size=0.0+(((DecodeFloat16(vec2(l9_24.xy),true)-0.0)*l9_28)/l9_20);
float l9_29=1.0-(-1.0);
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_24.zw),true)-0.0)*l9_29)/l9_20);
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_25.xy),true)-0.0)*l9_29)/l9_20);
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_25.zw),true)-0.0)*l9_29)/l9_20);
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_26.xy),true)-0.0)*l9_29)/l9_20);
gParticle.Mass=0.0+(((DecodeFloat16(vec2(l9_26.zw),true)-0.0)*l9_28)/l9_20);
float l9_30=1.00001-0.0;
float l9_31=1.0-0.0;
gParticle.Color.x=0.0+(((DecodeFloat8(l9_27.x,true)-0.0)*l9_30)/l9_31);
gParticle.Color.y=0.0+(((DecodeFloat8(l9_27.y,true)-0.0)*l9_30)/l9_31);
gParticle.Color.z=0.0+(((DecodeFloat8(l9_27.z,true)-0.0)*l9_30)/l9_31);
gParticle.Color.w=0.0+(((DecodeFloat8(l9_27.w,true)-0.0)*l9_30)/l9_31);
vec2 l9_32=l9_13+vec2(0.0014648438,0.0);
gParticle.collisionCount_N119=0.0+(((DecodeFloat8(texture2DLod(renderTarget0,sc_SamplingCoordsViewToGlobal(l9_32,renderTarget0Layout,renderTarget0GetStereoViewIndex()).xy,0.0).x,true)-0.0)*(255.0-0.0))/l9_31);
...
Interp_Particle_Index=float(ssInstanceID);
...
#else
{
vec2 l9_21=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_22;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_23=vec3(l9_21,0.0);
l9_23.y=((2.0*l9_21.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_22=l9_23.xy;
}
#else
{
...
#endif
l9_20=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_22,sc_ScreenTextureLayout,l9_24).xy,0.0);
}
#endif
vec3 l9_25=mix(l9_20.xyz,definedBlend(l9_20.xyz,l9_17.xyz).xyz,vec3(l9_16.x));
...
#if (sc_Voxelization)
{
l9_27=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_28;
#if (sc_OutputBounds)
{
float l9_29=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_28=vec4(l9_29,1.0-l9_29,1.0,1.0);
}
#else
{
vec4 l9_30;
...
{
l9_30=vec4(mix(vec3(1.0),l9_17.xyz,vec3(l9_16.x)),l9_16.x);
}
#else
{
vec4 l9_31;
...
#endif
l9_31=vec4(l9_17.xyz*l9_32,l9_32);
}
#else
{
l9_31=l9_17;
...
#endif
sc_writeFragData0Internal(l9_18,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
