...
#if (sc_FramebufferFetch)
{
l9_51=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_51=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_52,sc_ScreenTextureLayout,l9_53).xy,0.0);
}
#endif
vec3 l9_54=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_35.xyz).xyz,vec3(l9_17));
...
#if (sc_Voxelization)
{
l9_56=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_57;
#if (sc_OutputBounds)
{
float l9_58=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_57=vec4(l9_58,1.0-l9_58,1.0,1.0);
}
#else
{
vec4 l9_59;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_59=vec4(mix(vec3(1.0),l9_35.xyz,vec3(l9_17)),l9_17);
}
#else
{
vec4 l9_60;
...
#endif
l9_60=vec4(l9_35.xyz*l9_61,l9_61);
}
#else
{
l9_60=l9_35;
