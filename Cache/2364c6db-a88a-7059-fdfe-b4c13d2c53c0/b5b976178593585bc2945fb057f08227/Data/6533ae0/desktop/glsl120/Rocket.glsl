...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 84 -1
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 91 -1
//spec_const int Tweak_N25Layout 92 0
//spec_const int Tweak_N6Layout 93 0
//spec_const int intensityTextureLayout 94 0
//spec_const int planet_refl_mapLayout 95 0
...
#if (sc_FramebufferFetch)
{
l9_111=sc_readFragData0_Platform();
}
#else
{
...
{
l9_113=1-sc_GetStereoViewIndex();
}
#else
{
l9_113=sc_GetStereoViewIndex();
}
#endif
l9_111=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_112,sc_ScreenTextureLayout,l9_113).xy,0.0);
}
#endif
vec3 l9_114=mix(l9_111.xyz,definedBlend(l9_111.xyz,l9_95.xyz).xyz,vec3(Port_Value2_N053));
...
#if (sc_Voxelization)
{
l9_116=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_117;
#if (sc_OutputBounds)
{
float l9_118=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_117=vec4(l9_118,1.0-l9_118,1.0,1.0);
}
#else
{
vec4 l9_119;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_119=vec4(mix(vec3(1.0),l9_95.xyz,vec3(Port_Value2_N053)),Port_Value2_N053);
}
#else
{
vec4 l9_120;
...
{
l9_121=clamp(Port_Value2_N053,0.0,1.0);
}
#else
{
l9_121=Port_Value2_N053;
}
#endif
l9_120=vec4(l9_95.xyz*l9_121,l9_121);
}
#else
{
l9_120=l9_95;
...
vec4 l9_124=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_122,vec4(0.0)));
