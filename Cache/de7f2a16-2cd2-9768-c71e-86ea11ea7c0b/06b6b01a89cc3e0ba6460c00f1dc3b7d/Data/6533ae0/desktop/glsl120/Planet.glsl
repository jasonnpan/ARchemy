...
#if (sc_FramebufferFetch)
{
l9_65=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_65=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_66,sc_ScreenTextureLayout,l9_67).xy,0.0);
}
#endif
vec3 l9_68=mix(l9_65.xyz,definedBlend(l9_65.xyz,l9_48.xyz).xyz,vec3(l9_49));
...
#if (sc_Voxelization)
{
l9_70=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_71;
#if (sc_OutputBounds)
{
float l9_72=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_71=vec4(l9_72,1.0-l9_72,1.0,1.0);
}
#else
{
vec4 l9_73;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_73=vec4(mix(vec3(1.0),l9_48.xyz,vec3(l9_49)),l9_49);
}
#else
{
vec4 l9_74;
...
#endif
l9_74=vec4(l9_48.xyz*l9_75,l9_75);
}
#else
{
l9_74=l9_48;
