...
#if (sc_FramebufferFetch)
{
l9_40=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_40=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_41,sc_ScreenTextureLayout,l9_42).xy,0.0);
}
#endif
vec3 l9_43=mix(l9_40.xyz,definedBlend(l9_40.xyz,l9_24.xyz).xyz,vec3(l9_24.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_48=vec4(mix(vec3(1.0),l9_24.xyz,vec3(l9_24.w)),l9_24.w);
}
#else
{
vec4 l9_49;
...
#endif
l9_49=vec4(l9_24.xyz*l9_50,l9_50);
}
#else
{
l9_49=l9_24;
